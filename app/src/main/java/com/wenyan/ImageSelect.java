...
import com.util.GroupAdapter;
import com.util.ImageBean;
import com.wenyan.R;
...
public class ImageSelect extends Activity {
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case SCAN_OK:
				...
				adapter = new GroupAdapter(ImageSelect.this,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGroupGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(ImageSelect.this,
						ShowImageActivity.class);
				mIntent.putExtra("folderName", list.get(position)
						.getFolderName());
				mIntent.putStringArrayListExtra("data",
						(ArrayList<String>) childList);
				startActivityForResult(mIntent, MainActivity.PICK_IMAGE);
			}
		});
	}
	...
	private void getImages() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				ContentResolver mContentResolver = ImageSelect.this
						.getContentResolver();
	...
	/**
	 * 组装分组界面GridView的数据源，遍历HashMap将数据组装成List，并返回
	 * 
	 * @param mGruopMap
	 * @return
	 */
