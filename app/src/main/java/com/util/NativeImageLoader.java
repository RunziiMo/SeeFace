 ...
 * 调用loadNativeImage()方法加载本地图片，算是加载本地图片的工具类
 * 
 * @author Wouldyou
 * 
 */
public class NativeImageLoader {
	...
	/**
	 * 此方法来加载本地图片，这里的mPoint是用来封装ImageView的宽和高，根据ImageView控件的大小来压缩Bitmap
	 * 可以调用loadNativeImage(final String path, final NativeImageCallBack
	 * mCallBack)来加载，不压缩
	 * 
	 * @param path
	 * @param mPoint
	...
	private Bitmap decodeThumbBitmapForFile(String path, int viewWidth,
		...
		//
		// Bitmap okBitmap = Bitmap.createBitmap(tempBitmap, retX, retY, wh, wh,
		// null, false);
